 ...
 */
  $.fn.ajaxSubmit = function(options) {
    ...
    if (options.beforeSerialize && options.beforeSerialize(
        this, options) === false) {
    ...
    // https://github.com/malsup/form/commit/
    //   588306aedba1de01388032d5f42a60159eea9228#commitcomment-2180219
    ...
    if (options.iframe !== false && (options.iframe || shouldUseFrame)) {
      ...
      // see:  http://groups.google.com/group/jquery-dev/
      //   browse_thread/thread/36395b7ab510dd5d
    ...
    function deepSerialize(extraData) {
      ...
      for (i = 0; i < len; i++) {
        ...
        // #278; use array instead of object storage,
        //     favoring array serializations
    ...
    function fileUploadIframe(a) {
              ...
              if (s.extraData.hasOwnProperty(n)) {
                ...
                if ($.isPlainObject(s.extraData[n]) &&
                  ...
                  extraInputs.push(
                      ...
                      s.extraData[n].name + '">').val(s.extraData[n].value)
                                   .appendTo(form)[0]);
                } else {
                  extraInputs.push(
                      $('<input type="hidden" name="' +
      ...
      function cb(e) {
        ...
        try {
          ...
          if (!isXml && window.opera && (doc.body === null ||
            ...
            if (--domCheckCount) {
              ...
              // traversable when the onload callback fires,
        ...
        // ordering of these callbacks/triggers is odd,
        // but that's how $.ajax does it
        if (status === 'success') {
          if (s.success)
 ...
 * 2. This method will include the submit element's name/value data
 *    (for the element that was used to submit the form).
 ...
 *  v == ['C1']
 *
 * The successful argument controls whether or not
 *   the field element must be 'successful'
 ...
 * determined the array will be empty,
 ...
 */
  ...
  /**
 * Resets the form data.  Causes all form elements to be
